...
def ner_test():
    with BertClient(show_server_config=False, check_version=False, check_length=False, mode='NER') as bc:
        ...
        str1 = '溧阳市国土资源局国有土地使用权招拍挂出让成交公示按照《土地管理法》、《城市房地产管理法》、《招标拍卖挂牌出让国有土地使用权规定》和《招标拍卖挂牌出让国有土地使用权规范》等有关法律法规，遵循公开、公正、公平的原则。我局于至挂牌出让1宗国有土地使用权。现将有关情况公示如下：一、地块基本情况:地块编号NO.2012—77地块位置戴埠镇罛北工业园区杨树垛路东侧六号地块土地用途工业用地土地面积(公顷)2.232出让年限50年成交价(万元)724受让单位江苏宏盛建设机械有限公司土地使用条件：净地；地块位置戴埠镇罛北工业园区杨树垛路东侧六号地块,备注受让单位江苏宏盛建设机械有限公司土地使用条件：二、公示期：2012年07月06日至2012年07月12日三、该宗地双方已签订成交确认书，在30日内签订出让合同，相关事宜在合同中约定四、'
