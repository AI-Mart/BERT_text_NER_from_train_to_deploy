...
# model_dir = r'../../output'  #shiled by mart
# bert_dir = 'H:\models\chinese_L-12_H-768_A-12'  #shiled by mart

root_path = os.path.abspath(os.path.dirname(__file__)).split("bert_base")[0]  # chnage by mart2020-11-20防止移动文件由于路径问题出错
bert_dir = os.path.join(root_path,'roeberta_zh_L-12_H-768_A-12')  # change by mart 11-20 一定要记住sys函数在不同的python文件里面运行得到的结果是不一样的
model_dir = os.path.join(root_path,'output')#change by mart

is_training=False
use_one_hot_embeddings=False
batch_size=1
max_seq_length = 420#change by mart
