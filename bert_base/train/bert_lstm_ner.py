...
tf.logging.set_verbosity(tf.logging.INFO)#add by mart 20-11-28
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            hook_dict['global_steps'] = num_train_steps-tf.train.get_or_create_global_step()#change by mart 20-11-28
...
def train(args):
    ...
    if args.do_train and args.do_eval:
        ...
        # early stop hook   chnage by mart 20-11-18
