...
def set_logger(context, verbose=False):
    # if os.name == 'nt':  # for Windowsshield by mart 2020-11-22
    #     return NTLogger(context, verbose)shield by mart 2020-11-22

    if context!='NER Training':#add by mart 2020-11-22
        if os.name == 'nt':  # for Windows #add by mart 2020-11-22
            return NTLogger(context, verbose) #add by mart 2020-11-22
