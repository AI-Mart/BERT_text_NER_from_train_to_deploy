...
# model_dir = os.path.join(os.getcwd(),"output")#shield by mart
# bert_dir = os.path.join(os.getcwd(),"roeberta_zh_L-12_H-768_A-12")#shield by mart

model_dir = os.path.join(os.path.abspath(os.path.dirname(__file__)),"output")#change by mart 20-11-20 被其他函数调用还是当前文件的路径
bert_dir = os.path.join(os.path.abspath(os.path.dirname(__file__)),"roeberta_zh_L-12_H-768_A-12")#change by mart 20-11-20
